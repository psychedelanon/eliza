...
from agents.personas import CynicalSniper
from eliza.llm import complete


class AgentCynical(TwitterAgent, CynicalSniper):
    def __init__(self, *, idx: int, name: str, personality: str, dry_run: bool = False) -> None:
        ...
        CynicalSniper.__init__(self)

    def create_post(self) -> Tuple[str, Optional[str]]:
        text = complete(self.build_prompt(), temperature=0.9, max_tokens=80).strip()
